...
| TR-003 | MAP database | V004 draft đã chốt 4 bảng/18 cột; chưa có backup, migration thật hoặc JDBC source | backup + xác nhận migration + READY + JDBC payload verification |
