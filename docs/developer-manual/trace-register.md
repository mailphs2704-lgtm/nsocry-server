...
| --- | --- | --- | --- |
| TR-001 | DATA client asset | candidate authoritative đã VERIFIED; còn archive read-back, JDBC/runtime và startup wiring | archive checksum dry-run + persistence/runtime contract + startup integration test |
