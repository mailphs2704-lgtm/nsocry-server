...
| --- | --- | --- | --- |
| TR-001 | DATA client asset | candidate authoritative đã VERIFIED; archive read-back IMPLEMENTED_PENDING_VERIFY; còn JDBC/runtime và startup wiring | full-suite + archive thật giữ checksum, persistence/runtime contract + startup integration test |
