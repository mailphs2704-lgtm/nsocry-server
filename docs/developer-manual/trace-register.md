...
| --- | --- | --- | --- |
| TR-001 | DATA client asset | candidate/archive offline và V005 schema preflight 321/321 đã VERIFIED; còn preflight DB thật, import/JDBC runtime và startup wiring | DB preflight + import/checksum verify + runtime/startup integration test |
